                    ...
                    class="mt-2">
                      ...
                      <b-table striped hover :items="book" :fields="fields">
                        <template v-slot:cell(Aksi)="data">
                          ...
                          <b-button variant="primary" size="sm" v-on:click="Pinjam(data.item.id)" v-b-modal.modal_pinjam pill>
                              Pinjam
                          </b-button>
                        </template>
                      </b-table>
                      ...
                      <b-modal
                        ...
                        <b-container fluid>
                          <form v-on:submit="Save">
                            ...
                            Warna
                            <b-form-input v-model="warna" class="mb-2" required></b-form-input>
                            Deskripsi
                            <b-form-input v-model="description" class="mb-2" required></b-form-input>
                            Stok
                            <b-form-input type="number" v-model="stok" class="mb-2" required></b-form-input>
...
module.exports = {
  data : function(){
    return {
      ...
      sumdipinjam: "",
      // total: "",
      fields: ["id", "title", "warna", "description", "stok", "dipinjam", "Aksi"],
    }
  },
  methods: {
    getData : function(){
